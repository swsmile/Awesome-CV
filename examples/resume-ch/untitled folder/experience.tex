...
%---------------------------------------------------------
  \cventry
    ...
    {北京国双科技有限公司} % Organization
    {Seoul, S.Korea} % Location
    {2016-06 至 2017-07} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {负责各平台下的数据采集工作（横向组件），包括基于 Web 的用户网页浏览行为数据采集（JavaScript）、基于智能电视机顶盒或移动应用程序的用户观看行为数据采（JavaScript，Java）、基于 iOS 或 Android 应用程序的用户使用行为数据采集（Objective-C，Java）集}
